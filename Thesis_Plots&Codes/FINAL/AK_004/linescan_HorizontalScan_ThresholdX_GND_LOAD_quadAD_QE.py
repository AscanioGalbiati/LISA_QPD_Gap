...
# === PLOT RANGE (narrow) ===
# This is the default plot range, used for the first and subsequent files (except the second one)
x_min_plot_default = 7.24
x_max_plot_default = 7.40
...
calc_min_default = 7.15 #FROM CONFIG FILE
calc_max_default = 7.40
left_region_default = (calc_min_default, 7.29)
right_region_default = (7.35, calc_max_default)
gap_region_default = (7.29, 7.35) 

# Define specific regions for the second file (e.g., Y=2000 um, or index 1)
# *** ADJUST THESE VALUES TO YOUR ACTUAL SECOND FILE BOUNDARIES ***
calc_min_y2 = calc_min_default # Keeping calc_min/max the same as requested
calc_max_y2 = calc_max_default # Keeping calc_min/max the same as requested

# === NEW PLOT RANGE FOR Y_INDEX=1 ===
x_min_plot_y2 = 7.27
x_max_plot_y2 = 7.40

left_region_y2 = (calc_min_default, 7.315)
right_region_y2 = (7.355, calc_max_default)
gap_region_y2 = (7.315, 7.355) 
# =======================================================
...
csv_path = os.path.join(csv_dir, "Overshoot_Results_AD_Y_up_to_2200um.csv")
...
for y_um, y_folder in y_positions:
    ...
    if y_index == 0:
        ...
        # Use default plot range
        x_min_plot = x_min_plot_default
        x_max_plot = x_max_plot_default
    elif y_index == 1:
        # For the second scan, use the specific regions AND plot range
        current_regions = {
            # Calculation range remains the same as default, as requested
            'calc_min': calc_min_y2, 'calc_max': calc_max_y2,
            'left': left_region_y2, 'right': right_region_y2, 'gap': gap_region_y2
        }
        # *** APPLY THE SPECIFIC PLOT RANGE FOR THE SECOND FILE ***
    ...
    ax_load.set_xlim(x_min_plot+0.01, x_max_plot-0.01) # USES DYNAMIC x_min/max_plot
