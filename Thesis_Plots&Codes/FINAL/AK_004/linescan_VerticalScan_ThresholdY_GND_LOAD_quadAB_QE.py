...
# Default plot range
y_min_plot_default = 2.29
y_max_plot_default = 2.45
...
left_region_default  = (calc_min_default, 2.34)   # left plateau
right_region_default = (2.40, calc_max_default)   # right plateau
gap_region_default   = (2.34, 2.40)   # gap
