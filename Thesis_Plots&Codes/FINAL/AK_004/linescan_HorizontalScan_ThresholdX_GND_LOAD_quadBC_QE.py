...
# Base directory
base_dir = "/Users/asca/Documents/University/Master Thesis/code/Data/all quadrants/20251113/VIGO_NS089008_QPD_1000_20_AS_004_objLens_quadABCD_manual_setup_GND_LOAD_251111_Z7.0_NDfilter_POWER/HorizontalScan"
...
left_region_default  = (calc_min_default, 7.32)   # Left plateau
right_region_default = (7.38, calc_max_default)   # Right plateau
gap_region_default   = (7.32, 7.38)       # Gap 

# Regions for the SECOND PROCESSED FILE (y_index == 1)
# The request states calc_min and calc_max must STAY THE SAME.
calc_min_y2 = calc_min_default # Keep the calculation range constant
calc_max_y2 = calc_max_default # Keep the calculation range constant
left_region_y2  = (calc_min_y2, 7.31)   # Tweaked region 1
right_region_y2 = (7.37, calc_max_y2)   # Tweaked region 2
gap_region_y2   = (7.31, 7.37)       # Tweaked gap 
...
for y_um, y_folder in y_positions:
    ...
    fig_dir = os.path.join(y_folder, "fig_AS_004")
    ...
    ax_load.set_xlim(x_min_plot + 0.01, x_max_plot) # Uses dynamic x_min/max_plot
    ...
    ax_qe_gnd.set_ylabel(r'Quantum Efficiency $\eta$ [A/W]', color='#8b5a2b', fontsize=16) # Increased to 16
