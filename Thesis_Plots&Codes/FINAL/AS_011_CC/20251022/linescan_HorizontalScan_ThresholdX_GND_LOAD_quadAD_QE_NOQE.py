...
# Base directory
# === CORRECTED BASE DIR ===
base_dir = '/Users/asca/Documents/University/Master Thesis/code/Data/20251215_final_data/20251022/VIGO_NS089008_QPD_750_20_AS_0011_CC_251022_objLens_quadABCD_manual_setup_Z7.91mm_Yscan_thresholdX_YScan_FineSteps'
...
for y_um, y_folder in y_positions:
    ...
    fig_dir = os.path.join(y_folder, "fig") # NEW fig_dir name
    ...
    # <<< QE reference lines removed here >>>
    
    # QUANTUM EFFICIENCY LOAD
    QE_load = I_sum_load_plot / P_combined
    # <<< QE axis creation, data plotting, and formatting removed here >>>
    ...
    lines2 = []; labels2 = [] # Secondary axis handles/labels are now empty
    ...
    lines2g = []; labels2g = [] # Secondary axis handles/labels are now empty
    # Font size adjustment: 14
    ...
    ax_gnd.set_ylim(bottom=0, top = 0.02)
