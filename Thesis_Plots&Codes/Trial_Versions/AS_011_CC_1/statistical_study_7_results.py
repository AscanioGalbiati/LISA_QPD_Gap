...
Date: Dec 04 2025 — FINAL FINAL VERSION
'''
...
# === AXES CONFIGURATION === #
Y_LIM_BOTTOM = -8  # Final Requested Y limit bottom
...
devices = {
    ...
    "AS_011_CC_FL": {
        "path": "/Users/asca/Documents/University/Master Thesis/code/AS_011_CC/Fiber Laser/statistical study",
    ...
    "AK_004": {
        "path": "/Users/asca/Documents/University/Master Thesis/code/AK_004/statistical study",
        "color": RUN1_COLOR_GND, # Base Color (GND)
        "label": r'\textbf{AK\_004}', 
        "type": "Run1"
    },
    "AS_004": {
        "path": "/Users/asca/Documents/University/Master Thesis/code/AS_004/20251104/statistical study",
        "path_ND": "/Users/asca/Documents/University/Master Thesis/code/AS_004/20251110/statistical study",
        "color": RUN1_COLOR_GND, # Base Color (GND)
...
ax.set_xlabel(r'Device', fontsize=plt.rcParams['axes.labelsize'])
ax.set_ylabel(r'GS [\%]', fontsize=plt.rcParams['axes.labelsize'])
ax.set_title(r'\textbf{Gap Sensitivity Comparison Across QPD Devices}', fontsize=plt.rcParams['axes.titlesize'], pad=10)
