...
for y_um, y_folder in y_positions:
    ...
    ax_load.set_title(rf'\textbf{{DC Photocurrent LOAD (HL: Y={y_um}\textmu{{}}m)}}', fontsize=14, fontweight='bold', pad=10)
    ...
    ax_gnd.set_title(rf'\textbf{{DC Photocurrent GND (HL: Y={y_um}\textmu{{}}m)}}', fontsize=14, fontweight='bold', pad=10)
