...
for y_um, folder in sorted([(y_pos(os.path.basename(f)), f)
    ...
    fig_dir = os.path.join(folder,"fig_GND_LOAD"); os.makedirs(fig_dir, exist_ok=True)
    ...
    ax.set_title(rf'\textbf{{DC Photocurrent Gap Region Zoom (HL: Y={y_um}\textmu{{}}m)}}', fontsize=15, pad=10)
