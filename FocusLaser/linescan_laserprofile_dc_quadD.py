...
# ====================================== DATA ==================================================== #
data_dirs = {
    'Y_A': "/Users/asca/Documents/University/Master Thesis/code/Data/VIGO17_NS089008_QPD_0750_20_AS_015_CC_asca_250617_YScan_LB1471C_quadD/Y6100um"
}
...
data_collection = {'Y_A': []}
procdata = {
    'Y_A': {'quadD': {'z_positions': [], 'beamwaist_dc': []}}
}
all_z_positions = set()
...
for y_pos, data_dir in data_dirs.items():
    ...
    for z_mm, pkl_file in z_positions_with_files:
        ...
        # Extract DC photocurrent and calculate beam waist for quadD only
...
# Plot beam waist data for quadD
...
title = r'\textbf{DC Photocurrent (Y=6100\textmu{}m: quadD)}' # ADJUST FOR Y_A VALUE
...
# Print minimum beam waist for quadD
for y_pos in procdata:
    min_waist_A = min(procdata[y_pos]['quadD']['beamwaist_dc']) if procdata[y_pos]['quadD']['beamwaist_dc'] else float('inf')
