...
xstep = focuslaser_jsonconfig['global_params']['xystep_um']
ystart = focuslaser_jsonconfig['global_params']['ystart_um']
ystop = focuslaser_jsonconfig['global_params']['ystop_um']
ystep = focuslaser_jsonconfig['global_params']['xystep_um']
...
# Configure arrays for line scan
...
# Data save location
save_dir_base = pathlib.Path('{}/{}/GapScan/{}_{}_{}_{}_{}_{}_asca_14_A'.format(
    data_save_root, 
...
save_fname_str = "{}_{}_{}_{}_{}_{}_{}_QPDGapScan_KnifeEdge_asca_14_A".format(
    focuslaser_jsonconfig['dut']['batch'],
    focuslaser_jsonconfig['dut']['foundry'],
    focuslaser_jsonconfig['dut']['wafer'],
    focuslaser_jsonconfig['dut']['dut_type'],
