...
base_dir = "/Users/asca/Documents/University/Master Thesis/code/Data/manual setup/VIGO17_NS089008_QPD_0750_20_AS_015_CC_250714_YScan_LB1471C_quadA_manual_setup"
...
for y_um, y_folder in y_positions:
    ...
    fig.savefig(os.path.join(fig_dir, f"{fig_name}.png"), dpi=300)
    print(f"Figure saved: {os.path.join(fig_dir, f'{fig_name}.png')}")
