...
def connect_quadC_out1(ser):  # IN3 to OUT1 for Quadrant C
...
# Data save location
save_dir_base = pathlib.Path('{}/{}/GapScan/{}_{}_{}_{}_{}_{}_250918_LB1471C_quadA&C_manual_setup_Z50mm_Yscan_gap_identification'.format(
    data_save_root, 
...
save_fname_str = "{}_{}_{}_{}_{}_{}_{}_QPDGapScan_KnifeEdge_250918_LB1471C_quadA&C_manual_setup_Z50mm_Yscan_gap_identification".format(
    focuslaser_jsonconfig['dut']['batch'],
    focuslaser_jsonconfig['dut']['foundry'],
    focuslaser_jsonconfig['dut']['wafer'],
    focuslaser_jsonconfig['dut']['dut_type'],
...
for y in y_array:
    ...
    for idx, x in enumerate(x_array):
        ...
        # Measure DC photocurrent for Quadrant C (IN3 to OUT2)
        try:
            print(f"\nSwitching matrix to Quadrant C (IN3 to OUT2)...")
            connect_quadC_out1(ser)
        ...
        # Measure DC photocurrent for Quadrant A (IN4 to OUT2)
        try:
            print(f"\nSwitching matrix to Quadrant A (IN4 to OUT2)...")
    ...
    print(f"DC photocurrent Quadrant C = {np.mean(temp_measurements_c)}")
